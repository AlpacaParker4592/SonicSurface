...
<details>
  ...
  |JLCPCB|PCB 기판+스텐실 철판|1 (스텐실 작업용으로 추가 2개 권장, 설명서 참조)|[Link](https://cart.jlcpcb.com/quote?orderType=1&homeUploadNum=97627eda783a46f08d177d4509fd49e5&businessType=example&fileNameSonicSurface1.2_2Layers_183x169.zip)|
...
<details>
  ...
  |Amazon|FPGA 프로그래머|1|[Link](https://www.amazon.es/Waveshare-Download-Programming-Programmer-Debugger/dp/B00ID9BAUY/ref=sr_1_1?dib=eyJ2IjoiMSJ9.pJ6KQmrP2LctrOz-kMSqMXXfA4ov--utB485fOiAPyQ.MuUf_b9A_a2vgSnp4dbgAUGR5UO1FjtJPPbTX2heyuQ&dib_tag=se&keywords=Blaster+USB+ALTERA&qid=1715358515&sr=8-1)|
  ||납땜용 실납|||
  ||납땜용 인두|||
  ||기판 납땜용 리플로우 오븐|||
  ...
  ||납땜 잔여물 제거용 브러시|||
  ||발포 스티로폼 파티클|||
  |(약국 등)|이소프로필 알코올+주사기|알코올 500mL 이상, 주사기는 용량 자유||
</details>
